...
if (require.main === module) {
    ...
    program
        ...
        .option('--hide-window-frame', 'disable window frame and controls, should not be specified with --hide-title-bar together')
        .option('--hide-title-bar', 'disable window frame only, should not be specified with --hide-window-frame together')
