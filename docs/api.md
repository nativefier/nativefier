...
If you have the optional dependencies - `iconutil`; and Imagemagick `convert` and `identify`, or GraphicsMagic `gm` - in your `PATH`, Nativefier will automatically convert the `.png` to a `.icns` for you.
